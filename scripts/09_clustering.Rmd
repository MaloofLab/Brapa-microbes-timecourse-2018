...
# all trt
diurnal34.trt.DEGs.all.v3.0anno<-read_csv(file=file.path("..","output","dge.diurnal34.trt.DEGs.all.v3.0anno.csv"))
diurnal1314.trt.DEGs.all.v3.0anno<-read_csv(file=file.path("..","output","dge.diurnal1314.trt.DEGs.all.v3.0anno.csv"))
# all time
diurnal34.trt.DEGs.all.v3.0anno<-read_csv(file=file.path("..","output","dge.diurnal34.trt.DEGs.all.v3.0anno.csv"))
