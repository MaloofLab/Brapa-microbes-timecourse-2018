...
GSEA_reports.DF.custom$sampling_time <- gsub("(1_morn|2_afternoon|3_evening_5.30|4_night_1|5_night_2)(\\.)(01|02|03|04|06|08|13|14)(.custom.Gsea.)([[:print:]]+)","\\1", GSEA_reports.DF.custom$report2)
GSEA_reports.DF.custom$sampling_day <- gsub("(1_morn|2_afternoon|3_evening_5.30|4_night_1|5_night_2)(\\.)(01|02|03|04|06|08|13|14)(.custom.Gsea.)([[:print:]]+)","\\3", GSEA_reports.DF.custom$report2)
# Live or Blank
...
ggsave2(GSEA.timecourse_soil_all,filename="GSEA.timecourse_soil_all2.png",path=file.path("..","output"),width=20,height=8)
