...
## pvalue < 0.05
dge.diurnal34.interaction.trtlive.time.DEGs <- topTags(dge.diurnal34.anytime.lrt,n = Inf,p.value = 0.05)$table
...
dge.diurnal34.any.trtlive.DEGs.all <- topTags(dge.diurnal34.any.trtlive, n = Inf,p.value = 1)$table
## pvalue < 0.05
dge.diurnal34.any.trtlive.DEGs <- topTags(dge.diurnal34.any.trtlive.lrt,n = Inf,p.value = 0.05)$table;nrow(dge.diurnal34.trt.DEGs) # 4593
```
...
nrow(dge.diurnal1314.anytime.DEGs) # 1???? something is wrong???
...
nrow(dge.diurnal1314.trtlive.DEGs) #
```
