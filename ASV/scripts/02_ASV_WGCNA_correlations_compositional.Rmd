...
```
We lost one sample due to sparsity, so let's update the sample description to match
...
# I AM HERE.  NEED TO CONVERT TO APPROPRIATE COR FUNCTION PER GLOOR PAPER
