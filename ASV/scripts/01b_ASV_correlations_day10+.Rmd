...
```{r}
cbind(rna_live10[,"BraA07g000630.3C"], asv_live10_small[,"ASV86"]) %>% cor(method = "pearson")
cbind(rna_live10[,"BraA07g000630.3C"], asv_live10_small[,"ASV86"]) %>% cor(method = "spearman")
cbind(rna_live10[,"BraA07g000630.3C"], asv_live10_small[,"ASV86"]) %>% cor(method = "kendall")
